<?php /* Smarty version Smarty-3.1.18, created on 2016-10-28 01:16:39
         compiled from "simpla/design/html/deals.tpl" */ ?>
<?php /*%%SmartyHeaderCode:165805882158127cc766aa42-92494935%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a9bb43961deee070cc922a043f40399a8e34ef5' => 
    array (
      0 => 'simpla/design/html/deals.tpl',
      1 => 1476915724,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '165805882158127cc766aa42-92494935',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58127cc7892181_97517086',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58127cc7892181_97517086')) {function content_58127cc7892181_97517086($_smarty_tpl) {?>
...
<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable('Сделки на аукционе', null, 1);
...
<div id="header">
	<h1><?php if ($_smarty_tpl->tpl_vars['deals_count']->value) {?>Количество сделок: <?php echo $_smarty_tpl->tpl_vars['deals_count']->value;?>
<?php }?></h1>		
...
?>
			<div class="<?php if ($_smarty_tpl->tpl_vars['order']->value->paid) {?>green<?php }?> row" <?php if ($_smarty_tpl->tpl_vars['order']->value->is_bot==1) {?>style="background:#f9eaea"<?php }?>>
...
"></span>
					<?php } ?>
	 				<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'DealAdmin','id'=>$_smarty_tpl->tpl_vars['order']->value->id,'return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
">Сделка №<?php echo $_smarty_tpl->tpl_vars['order']->value->id;?>
</a> <u><?php echo $_smarty_tpl->tpl_vars['order']->value->user_login;?>
</u>
				...
				<div class="icons cell">
					<a href='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'DealAdmin','id'=>$_smarty_tpl->tpl_vars['order']->value->id,'view'=>'print'),$_smarty_tpl);?>
'  target="_blank" class="print" title="Печать заказа"></a>
					<?php if ($_smarty_tpl->tpl_vars['status']->value<3) {?><a href='#' class=delete title="Передать в возвращенные"></a><?php }?>
				</div>
 ...
 <?php echo $_smarty_tpl->tpl_vars['currency']->value->sign;?>
		...
		<span id="select">
		<select name="action">
			<?php if ($_smarty_tpl->tpl_vars['status']->value!==0) {?><option value="set_status_0">Выйгран</option><?php }?>
			<?php if ($_smarty_tpl->tpl_vars['status']->value!==1) {?><option value="set_status_1">Выкуплен</option><?php }?>
			<?php if ($_smarty_tpl->tpl_vars['status']->value!==2) {?><option value="set_status_2">Оплачен</option><?php }?>
			<?php  $_smarty_tpl->tpl_vars['l'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['l']->_loop = false;
