<?php /* Smarty version Smarty-3.1.18, created on 2016-10-25 00:27:20
         compiled from "simpla/design/html/pages.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1232343005580e7cb880b798-96470444%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1232343005580e7cb880b798-96470444',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_580e7cb8c223d9_74843502',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580e7cb8c223d9_74843502')) {function content_580e7cb8c223d9_74843502($_smarty_tpl) {?>
...
"><?php echo $_smarty_tpl->tpl_vars['m']->value->name;?>
	...
	<?php } ?>
	<?php }?>
	<li><a href="index.php?module=BlogAdmin">Новости</a></li>
...
">
		<div id="list">		
		<?php if ($_smarty_tpl->tpl_vars['menu']->value->name=='Словарь') {?>
			<?php  $_smarty_tpl->tpl_vars['page'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['page']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['slovar_pages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['page']->key => $_smarty_tpl->tpl_vars['page']->value) {
$_smarty_tpl->tpl_vars['page']->_loop = true;
?>
			<div class="<?php if (!$_smarty_tpl->tpl_vars['page']->value->visible) {?>invisible<?php }?> row slovar">
...
"><p class="slovar_item"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value->header, ENT_QUOTES, 'UTF-8', true);?>
</p></a>
				</div>
