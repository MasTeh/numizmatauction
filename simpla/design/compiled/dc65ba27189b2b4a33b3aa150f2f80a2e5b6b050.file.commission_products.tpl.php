<?php /* Smarty version Smarty-3.1.18, created on 2016-10-24 19:47:12
         compiled from "simpla/design/html/commission_products.tpl" */ ?>
<?php /*%%SmartyHeaderCode:940465216580e3b1070eca4-92963294%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dc65ba27189b2b4a33b3aa150f2f80a2e5b6b050' => 
    array (
      0 => 'simpla/design/html/commission_products.tpl',
      1 => 1459277914,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '940465216580e3b1070eca4-92963294',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_580e3b10bcddf2_85323557',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580e3b10bcddf2_85323557')) {function content_580e3b10bcddf2_85323557($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/u457006/numisrus.ru/www/Smarty/libs/plugins/modifier.truncate.php';
?>
...
<div id="header">	
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->tpl_vars['products_count']->value,'товар','товаров','товара');?>
	...
	<?php } else { ?>
		<h1>Нет товаров</h1>
	<?php }?>
	<a class="add" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'CommissionProductAdmin','return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
">Добавить товар</a>
</div>	
...
?>
		<div class="<?php if (!$_smarty_tpl->tpl_vars['product']->value->visible) {?>invisible<?php }?> <?php if ($_smarty_tpl->tpl_vars['product']->value->featured) {?>featured<?php }?> row" <?php if ($_smarty_tpl->tpl_vars['product']->value->status=='1') {?>style="background:#FCFFD9"<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['product']->value->status=='2') {?>style="background:#ffe6e6"<?php }?>>
...
"/>				
			...
			<div class="image cell">
				...
				<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'CommissionProductAdmin','id'=>$_smarty_tpl->tpl_vars['product']->value->id,'return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
...
" /></a>
 ...
 $_from = $_smarty_tpl->tpl_vars['product']->value->comvariants; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
				<li <?php if (!$_smarty_tpl->tpl_vars['variant']->first) {?>class="variant" style="display:none;"<?php }?>>
					...
					<?php echo number_format($_smarty_tpl->tpl_vars['variant']->value->price,0,"."," ");?>
 <?php echo $_smarty_tpl->tpl_vars['currency']->value->sign;?>
				...
				<?php $_smarty_tpl->tpl_vars['variants_num'] = new Smarty_variable(count($_smarty_tpl->tpl_vars['product']->value->comvariants), null, 0);?>
 ...
 ↑</a>
				...
				<a style="display:inline-block;width:200px" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'CommissionProductAdmin','id'=>$_smarty_tpl->tpl_vars['product']->value->id,'return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</a>

				<?php if ($_smarty_tpl->tpl_vars['product']->value->user) {?><a href="index.php?module=UserAdmin&id=<?php echo $_smarty_tpl->tpl_vars['product']->value->user->id;?>
"><?php echo $_smarty_tpl->tpl_vars['product']->value->user->fam;?>
 <?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value->user->name,1,'');?>
 <?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value->user->otch,1,'');?>
</a>, #<?php echo $_smarty_tpl->tpl_vars['product']->value->user->id;?>
<?php }?>
...
">Все товары</a></li>
		<li <?php if ($_smarty_tpl->tpl_vars['filter']->value=='preparation') {?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'brand_id'=>null,'category_id'=>null,'page'=>null,'filter'=>'preparation'),$_smarty_tpl);?>
">В обработке</a></li>
		<li <?php if ($_smarty_tpl->tpl_vars['filter']->value=='ready') {?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'brand_id'=>null,'category_id'=>null,'page'=>null,'filter'=>'ready'),$_smarty_tpl);?>
">Готовы к аукциону</a></li>
		<li <?php if ($_smarty_tpl->tpl_vars['filter']->value=='toback') {?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'brand_id'=>null,'category_id'=>null,'page'=>null,'filter'=>'toback'),$_smarty_tpl);?>
">На возврат</a></li>
