	...
	<div id="column_left">
		...
		<div class="block">
			<ul>
				...
				{$perms = [
					'products'   =>'Интернет-магазин: товары, заказы, категории (в т.ч. и для аукциона)',
					'comission'	 =>'Товары на комиссии',
					'deals'	 	 =>'Сделки на аукционе',
					'auctions_list'	 =>'Список аукционов',
					'lots'	 =>'Просмотр выставленных лотов и возврат их на комиссию',
					'auction_start'	 =>'Запуск аукциона',
					'users'      =>'Пользователи аукциона (покупатели, продавцы)',
					'pages'      =>'Контент',
					'design'     =>'Правка вёрстки HTML-страниц',
					'settings'   =>'Настройки',
					'delivery'   =>'Способы доставки',
					'payment'    =>'Способы оплаты',
					'managers'   =>'Менеджеры (назначать только главному админу)'
				]}
