...
<div id="main_list">
	...
	<form id="list_form" method="post">
		...
		<div id="list">		
		{if $menu->name=='Словарь'}
			{foreach $slovar_pages as $page}
			<div class="{if !$page->visible}invisible{/if} row slovar">
				...
				<div class="name cell">
					<a href="{url module=PageAdmin id=$page->id return=$smarty.server.REQUEST_URI}"><p class="slovar_item">{$page->header|escape}</p></a>
				</div>
